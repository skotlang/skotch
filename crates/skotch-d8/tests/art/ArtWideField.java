public class ArtWideField {
    long base;
    ArtWideField(long b) { base = b; }
    ...
    public static void main(String[] z) {
        System.out.println(new ArtWideField(1000L).compute(2));
        System.out.println(new ArtWideField(50L).compute(5));
        System.out.println(new ArtWideField(-7L).compute(0));
    }
}
