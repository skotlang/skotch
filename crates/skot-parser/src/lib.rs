//! Hand-rolled recursive-descent parser for the Kotlin 2 subset skot
//! currently accepts.
//!
...
//!    iterating on the AST shape (`skot-syntax`). Once the AST stabilizes
...
use skot_intern::{Interner, Symbol};
use skot_lexer::{LexedFile, TokenPayload};
use skot_span::{FileId, Span};
use skot_syntax::{
