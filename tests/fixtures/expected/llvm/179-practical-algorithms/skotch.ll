...
define i32 @InputKt_factorial(i32 %arg0) {
entry:
  %merge_2 = alloca i32
  %merge_5 = alloca i32
  %t0 = add i32 0, 1
...
bb4:
  ...
  %t11 = add i32 0, 1
  %t12 = add i32 0, 7
  store i32 %t11, ptr %merge_14
  br label %bb8
bb5:
  %t13 = load i32, ptr %merge_2
...
bb7:
  br label %bb3
bb8:
  %t15 = load i32, ptr %merge_14
  %t16 = icmp sle i32 %t15, %t12
  br i1 %t16, label %bb9, label %bb11
bb9:
  %t17 = load i32, ptr %merge_14
  %t18 = call i32 @InputKt_factorial(i32 %t17)
  call i32 (ptr, ...) @printf(ptr @.fmt.int_println, i32 %t18)
  br label %bb10
bb10:
  %t20 = add i32 0, 1
  %t21 = load i32, ptr %merge_14
  %t22 = add i32 %t21, %t20
  store i32 %t22, ptr %merge_14
  br label %bb8
bb11:
  ret i32 0
}
